...
class PatientRecordContract extends Contract {
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
        var queryJson = {"selector": {"gender": gender}};
        return await this.queryWithQueryString(ctx, JSON.stringify(queryJson));    
    }
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
        var queryJson = {"selector": {"blood_type": blood_type}};
        return await this.queryWithQueryString(ctx, JSON.stringify(queryJson));   
    }
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
        var queryJson = {
            ...
            "use_index":["_design/bloodTypeIndexDoc", "bloodTypeIndex"]
        };
        return await this.queryWithQueryString(ctx, JSON.stringify(queryJson));
    }
}
